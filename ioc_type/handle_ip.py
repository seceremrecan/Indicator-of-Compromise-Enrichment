...
from modules.abuseipdb import fetch_abuse_ipdb_data
from modules.greynois import query_greynoise


async def handle_ip(ioc: str):
    ...
    db_ioc = IoC(
        ...
        abuse_ip_db=abuseipdb_data_str,
        grey_nois_data=grey_nois_data,
    )
    status = create_specific_ioc_db(db_ioc, IoC)
    return status
